...
public class CharacterMovementHelper : MonoBehaviour
{
    ...
    {
        /*
        Debug.Log("UpdateCharacterController xRRig"+ xRRig);
        Debug.Log("UpdateCharacterController characterController" + characterController);
        Debug.Log("UpdateCharacterController ");
        Debug.Log("UpdateCharacterController ");
