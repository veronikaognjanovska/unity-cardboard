...
IL2CPP_EXTERN_C String_t* _stringLiteral06E01B1A1B5648C2C9DFA7D7C996BE78038A8A91;
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void MoveTo_Update_mB7372CAC7DC40875B53DD7AE1EAACC60E960060B (MoveTo_tD0D21E4DD707A66B766683BF3D9D3D4559AC3981 * __this, const RuntimeMethod* method)
{
	...
	if (!s_Il2CppMethodInitialized)
	{
		...
		il2cpp_codegen_initialize_runtime_metadata((uintptr_t*)&Object_tF2F3778131EFF286AF62B7B013A170F95A91571A_il2cpp_TypeInfo_var);
		il2cpp_codegen_initialize_runtime_metadata((uintptr_t*)&_stringLiteral06E01B1A1B5648C2C9DFA7D7C996BE78038A8A91);
	...
	memset((&V_2), 0, sizeof(V_2));
	{
		...
		Transform_tA8193BB29D4D2C7EC04918F3ED1816345186C3F1 * L_14 = __this->get_camera_4();
		NullCheck(L_14);
		Vector3_t65B972D6A585A0A5B63153CF1177A90D3C90D65E  L_15;
		L_15 = Transform_get_position_m40A8A9895568D56FFC687B57F30E8D53CB5EA341(L_14, /*hidden argument*/NULL);
		V_1 = L_15;
		String_t* L_16;
		L_16 = Vector3_ToString_mD5085501F9A0483542E9F7B18CD09C0AB977E318((Vector3_t65B972D6A585A0A5B63153CF1177A90D3C90D65E *)(&V_1), /*hidden argument*/NULL);
		Transform_tA8193BB29D4D2C7EC04918F3ED1816345186C3F1 * L_17 = __this->get_camera_4();
		NullCheck(L_17);
		...
		V_2 = L_18;
		String_t* L_19;
		L_19 = Quaternion_ToString_mD3D4C66907C994D30D99E76063623F7000F6998E((Quaternion_t6D28618CF65156D4A0AD747370DDFD0C514A31B4 *)(&V_2), /*hidden argument*/NULL);
		String_t* L_20;
		L_20 = String_Concat_m89EAB4C6A96B0E5C3F87300D6BE78D386B9EFC44(_stringLiteral06E01B1A1B5648C2C9DFA7D7C996BE78038A8A91, L_16, L_19, /*hidden argument*/NULL);
		Debug_Log_mC26E5AD0D8D156C7FFD173AA15827F69225E9DB8(L_20, /*hidden argument*/NULL);
		// if (Physics.Raycast(ray, out hit))
		bool L_21;
		L_21 = Physics_Raycast_m80EC8EEDA0ABA8B01838BA9054834CD1A381916E(L_13, (RaycastHit_t59E5AEC8FE13BFA2ACBB6FFBDB7585FFB7288F89 *)(&V_0), /*hidden argument*/NULL);
		if (!L_21)
		{
			goto IL_0197;
		}
	}
	{
		...
		L_22 = RaycastHit_get_collider_m13A3DE16FBC631E0A1F987E0B22CE70AF8AB539E((RaycastHit_t59E5AEC8FE13BFA2ACBB6FFBDB7585FFB7288F89 *)(&V_0), /*hidden argument*/NULL);
		NullCheck(L_22);
		...
		// if (hitObject == ground)
		GameObject_tC000A2E1A7CF1E10FD7BA08863287C072207C319 * L_24 = __this->get_ground_5();
		IL2CPP_RUNTIME_CLASS_INIT(Object_tF2F3778131EFF286AF62B7B013A170F95A91571A_il2cpp_TypeInfo_var);
		bool L_25;
		L_25 = Object_op_Equality_mEE9EC7EB5C7DC3E95B94AB904E1986FC4D566D54(L_23, L_24, /*hidden argument*/NULL);
		if (!L_25)
		{
			goto IL_0162;
		}
	}
	{
		...
		V_1 = L_26;
		String_t* L_27;
		L_27 = Vector3_ToString_mBD710BF9F46219074EE5B095F064EAB4F73B64C1((Vector3_t65B972D6A585A0A5B63153CF1177A90D3C90D65E *)(&V_1), _stringLiteral2409165FB90CD4A8B916FCA75790766B82C91748, /*hidden argument*/NULL);
		String_t* L_28;
		L_28 = String_Concat_m4B4AB72618348C5DFBFBA8DED84B9E2EBDB55E1B(_stringLiteral64F1A468F75643F5CD44D53D75DA3C68787FD477, L_27, /*hidden argument*/NULL);
		IL2CPP_RUNTIME_CLASS_INIT(Debug_tEB68BCBEB8EFD60F8043C67146DC05E7F50F374B_il2cpp_TypeInfo_var);
		Debug_Log_mC26E5AD0D8D156C7FFD173AA15827F69225E9DB8(L_28, /*hidden argument*/NULL);
		// float dist = Vector3.Distance(hit.point, transform.position);
		Vector3_t65B972D6A585A0A5B63153CF1177A90D3C90D65E  L_29;
		L_29 = RaycastHit_get_point_m32F7282CBB2E13393A33BAD046BDA218E48DD21E((RaycastHit_t59E5AEC8FE13BFA2ACBB6FFBDB7585FFB7288F89 *)(&V_0), /*hidden argument*/NULL);
	...
	}
	{
		...
		L_34 = RaycastHit_get_point_m32F7282CBB2E13393A33BAD046BDA218E48DD21E((RaycastHit_t59E5AEC8FE13BFA2ACBB6FFBDB7585FFB7288F89 *)(&V_0), /*hidden argument*/NULL);
		float L_35 = L_34.get_x_2();
		Vector3_t65B972D6A585A0A5B63153CF1177A90D3C90D65E  L_36;
		L_36 = RaycastHit_get_point_m32F7282CBB2E13393A33BAD046BDA218E48DD21E((RaycastHit_t59E5AEC8FE13BFA2ACBB6FFBDB7585FFB7288F89 *)(&V_0), /*hidden argument*/NULL);
		float L_37 = L_36.get_z_4();
		Vector3_t65B972D6A585A0A5B63153CF1177A90D3C90D65E  L_38;
		memset((&L_38), 0, sizeof(L_38));
		Vector3__ctor_m57495F692C6CE1CEF278CAD9A98221165D37E636_inline((&L_38), L_35, (2.0f), L_37, /*hidden argument*/NULL);
		NullCheck(L_33);
...
IL_012c:
	{
		...
		Transform_tA8193BB29D4D2C7EC04918F3ED1816345186C3F1 * L_40 = __this->get_camera_4();
		NullCheck(L_40);
		...
		Transform_tA8193BB29D4D2C7EC04918F3ED1816345186C3F1 * L_43 = __this->get_camera_4();
		NullCheck(L_43);
		...
		Vector3__ctor_m57495F692C6CE1CEF278CAD9A98221165D37E636_inline((&L_46), L_42, (2.0f), L_45, /*hidden argument*/NULL);
		NullCheck(L_39);
		Transform_set_position_mB169E52D57EEAC1E3F22C5395968714E4F00AC91(L_39, L_46, /*hidden argument*/NULL);
		// }
		return;
	}
...
IL_0162:
	{
		...
		Transform_tA8193BB29D4D2C7EC04918F3ED1816345186C3F1 * L_48 = __this->get_camera_4();
		NullCheck(L_48);
		...
		Transform_tA8193BB29D4D2C7EC04918F3ED1816345186C3F1 * L_51 = __this->get_camera_4();
		NullCheck(L_51);
		...
		Vector3__ctor_m57495F692C6CE1CEF278CAD9A98221165D37E636_inline((&L_54), L_50, (2.0f), L_53, /*hidden argument*/NULL);
		NullCheck(L_47);
